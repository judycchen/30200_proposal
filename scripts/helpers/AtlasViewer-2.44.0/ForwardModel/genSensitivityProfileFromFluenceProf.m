...
for iW=1:fwmodel.nWavelengths
    ...
    %% added by Shan Gao for testing
    % will be saved to data files' directory
    save('As.mat', 'As');  % As is a vector of length: nNodes
    save('Ad.mat', 'Ad');  % Ad is a vector of length: nNodes
    save('voxPerNode.mat', 'voxPerNode');  % voxPerNode is a vector of length: nNodes
    %%
    ...
    % Get Adot
    % Adot has shape (nMeasurement, nNodes, nWavelength)
